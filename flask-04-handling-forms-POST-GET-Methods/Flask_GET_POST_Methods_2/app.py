...
def lcm(num1,num2):
    common_muliplication = []
    for i in range(max(num1,num2), num1*num2+1):
        if i%num1==0 and i%num2==0:
            common_muliplication.append(i)
    return min(common_muliplication)
...
def calculate():
    if request.method == "POST":
        ...
        return render_template("result.html", var1 = num1, var2 = num2, result = lcm(int(num1),int(num2)), developer_name = "frank")
    else:
        return render_template("result.html", developer_name="frank")
